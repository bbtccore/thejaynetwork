...
thereby removing the old validator set and introducing a new set suitable for local testing purposes.`

	cmd.Example = fmt.Sprintf(`jaynd in-place-testnet testing-1 yjayvaloper1w7f3xx7e75p4l7qdym5msqem9rd4dyc4mq79dm --home $HOME/.jayn/validator1 --validator-privkey=6dq+/KHNvyiw2TToCgOpUpQKIzrLs69Rb8Az39xvmxPHNoPxY1Cil8FY+4DhT9YwD6s0tFABMlLcpaylzKKBOg== --accounts-to-fund="yjay1f7twgcq4ypzg7y24wuywy06xmdet8pc4473tnq,yjay1qvuhm5m644660nd8377d6l7yz9e9hhm9evmx3x"`)
